...
function MCprotonA_Hybrid7(B0,phi_angle,omega_angle,TE,Gx,ROIx1,ROIx2,...
...
save_name=['MCprotonA_Hybrid7_' save_name_str sprintf('_B0_%2.1fT_ori_[%d_%d]_TE%dms_Gx%d_ROI_[%d %d %d %d %d %d]_frame_%d_volFrame_%d',B0,phi_angle,omega_angle,TE,Gx,ROIx1,ROIx2,ROIy1,ROIy2,ROIz1,ROIz2,iFrame,vol_iFrame) '.mat'];
