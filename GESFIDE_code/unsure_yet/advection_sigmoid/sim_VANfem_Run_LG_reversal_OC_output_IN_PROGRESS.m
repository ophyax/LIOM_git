function [c,cg,cbg,t,AmatFlux,BmatFlux, OCoutput] = sim_VANfem_Run_LG_reversal_OC_output_IN_PROGRESS( im, nIter, nIterPerPlot, AmatFlux, BmatFlux, c, cg, cbg, tStart, BCvec )
