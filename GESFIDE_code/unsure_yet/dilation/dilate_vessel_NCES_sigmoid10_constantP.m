...
load /autofs/cluster/bartman/2/users/lgagnon/2013/mouse_20100203/baseline_flow_new/brOrder.mat
im2.grpStat=grpStat;
...
a1=3;
a2=2;
a3=10; %percent changes in amplitude
...
if 1
    ...
    save dilate_vessel_NCES_Sigmoid10.mat Ftime Ptime Vtime Fedges tFlow;
