...
================================
-dilate_vessel_NCES_sigmoid30_constantP 
-run_dilate_vessel_NCES_sigmoid30_constantP.sh (shell script run to temporarily set 
                                                environment variables and execute the 
                                                application)
   -to run the shell script, type
   
       ./run_dilate_vessel_NCES_sigmoid30_constantP.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2010a/v714, run the shell script as:
       ...
       ./run_dilate_vessel_NCES_sigmoid30_constantP.sh /mathworks/home/application/R2010a/v714
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_dilate_vessel_NCES_sigmoid30_constantP.sh /mathworks/devel/application/matlab
-MCRInstaller.bin
    ...
    Linux                   LD_LIBRARY_PATH
     ...
     ii. Set the path by doing one of the following:
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_dilate_vessel_NCES_sigmoid30_constantP.sh 
