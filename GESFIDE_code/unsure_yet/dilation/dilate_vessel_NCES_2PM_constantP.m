...
load /autofs/cluster/bartman/2/users/lgagnon/2013/mouse_20100203/baseline_flow/brOrder.mat
im2.grpStat=grpStat;
...
if 1
    ...
    print_flag=8; %number represent #of frame skipped between display
    [Ftime,Ptime,Vtime,Fedges,segNodeMap]=flowCircuitEq_dyn_LG_dP_v3( im2, tFlow, seg_dvdt_t, segDilationDynType, lstAll, climvalueVol, climvalueFlow, climvalueDilation, climvaluePressure, lstSegActive, lstSegPassive, print_flag );
    save dilate_vessel_NCES_2PM.mat Ftime Ptime Vtime Fedges tFlow;
