...
function [Ftime,Ptime,segVolTime,Fedges,segNodeMap]=flowCircuitEq_dyn_LG_dP_v3( im, tDyn, seg_dvdt_t, segDilationDynType, lstBvis, climvalueVol, climvalueFlow, climvalueDilation, climvaluePressure, lstSegActive, lstSegPassive, print_flag )
